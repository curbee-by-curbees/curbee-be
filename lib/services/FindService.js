...
export default class FindService {
  ...
  static async updateFind(find, id) {
    const updatedFind = await Find.update(find, id);

    return updatedFind;
  }

  static async claimFind(id) {
    const claimedFind = await Find.claim(id);
